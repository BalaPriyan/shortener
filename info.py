...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/TomenMovie')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/TomenMain')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/kalai_support/9')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'HELLO BUDDY 🌱')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ''))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'TomenMovie')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'https://tomen-tomenmain.koyeb.app'))
